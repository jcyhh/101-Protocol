<template>
    ...
    <div class="pl30 pr30 pt30">
        ...
        <div class="flex jb ac">
            <div class="size24 gray">我的邮箱</div>
        ...
        <div v-if="userInfo?.upgrade_level">
            <div class="flex jb ac mt10 mt40 mb20">
                <div class="size24 bold6">升级 {{ userInfo?.upgrade_level?.name }} 条件 </div>
        ...
        <div class="card mt30">
            ...
            <div class="flex jb ac mt30">
                <div class="flex ac">
                    ...
                    <div class="size24 opc5">团队业绩</div>
                </div>
                <div class="size24">
                    <span v-init="userInfo?.team_kpi"></span>
                    <span class="ml5">{{ assetUSDT }}</span>
            ...
            <div class="flex jb ac mt30">
                <div class="flex ac">
                    ...
                    <div class="size24 opc5">个人业绩</div>
                </div>
                <div class="size24">
            ...
            <div class="flex jb ac mt30">
                <div class="flex ac">
                    ...
                    <div class="size24 opc5">团队新增业绩</div>
                </div>
                <div class="size24">
